...
export const Card = React.memo(({ card, index, hovered, setHovered, navigate }) => (
  <div
    ...
    >
      <div className="text-xl w-[100%] font-bold bg-clip-text text-transparent text-white">
        <div className="felx justify-center items-center w-[100%] flex-col gap-2 rounded-md bg-opacity-75">
          ...
          <button
            className='rounded-md p-2 px-3 bg-gray-300 bg-opacity-40 text-white text-transparent font-semibold'
